...
var _default = _ref => {
  ...
  async function onProjectCreate() {
    await (0, _consolid.createProject)((0, _uuid.v4)(), [(0, _solidClientAuthnBrowser.getDefaultSession)().info.webId], (0, _solidClientAuthnBrowser.getDefaultSession)());
    await getMyProjects();
  }
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_core.Container, {
    component: "main"
  }, (0, _solidClientAuthnBrowser.getDefaultSession)().info.isLoggedIn ? /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement(_core.Button, {
    fullWidth: true,
    variant: "contained",
    color: "primary",
  ...
  }, "Get my projects"), /*#__PURE__*/_react.default.createElement(_core.Button, {
    fullWidth: true,
    variant: "contained",
    color: "primary",
    onClick: () => onProjectCreate()
  }, "Create new project"), myProjects.map(item => {
